...
function Keyboard(Splide2, Components2, options) {
  var _EventInterface0 = EventInterface(Splide2),
    on = _EventInterface0.on,
    bind = _EventInterface0.bind,
    unbind = _EventInterface0.unbind;
  var root = Splide2.root;
  var resolve = Components2.Direction.resolve;
  var target;
  var disabled;
...
function LazyLoad(Splide2, Components2, options) {
  var _EventInterface1 = EventInterface(Splide2),
    on = _EventInterface1.on,
    off = _EventInterface1.off,
    bind = _EventInterface1.bind,
    emit = _EventInterface1.emit;
...
var SplideRenderer = /*#__PURE__*/function () {
  ...
  _proto3.renderSlides = function renderSlides() {
    ...
    return this.slides.map(function (content) {
      return "<" + tag + " " + _this0.buildAttrs(content.attrs) + ">" + (content.html || "") + "</" + tag + ">";
    }).join("");
  };
